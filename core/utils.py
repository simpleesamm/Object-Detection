    ...
    for i in range(num_boxes[0]):
        ...
        if class_name not in allowed_classes:
            ...
            if show_label:
                ...
                c4 = (coor[1], coor[2])
                c5 = (coor[1] + t_size[0], coor[2]+ t_size[1] + 3)
                cv2.rectangle(image, c4, (np.float32(c5[0]), np.float32(c5[1])), bbox_color, -1) #filled

                cv2.putText(image, bbox_mess, (c1[0], np.float32(c2[1] + 18)), cv2.FONT_HERSHEY_SIMPLEX,
